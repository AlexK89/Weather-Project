...
//======================================
    ...
    function getWeather(search_string){
        $('#search_string').val('');
        $.getJSON( 'http://api.openweathermap.org/data/2.5/forecast/daily?q=' + search_string + '&units=metric&cnt=10&appid=8ce8d052973edd56b69fdc48d4309715',
            function (data) {
                console.log(data);
                fill_form(data);
            }
    ...
    function fill_form(data) {
        ...
        $.each(data.list, function(){
            ...
            var superDay = moment(localTime).format('dddd')+ ', ' +moment(localTime).format("MMM Do");
            addWeather(
                this.weather[0].icon,
