...
//======================================
    ...
    function getWeather(search_string){
        $('#search_string').val('');
        $.getJSON( 'http://api.openweathermap.org/data/2.5/forecast?q=' + search_string + '&appid=8ce8d052973edd56b69fdc48d4309715&units=metric&cnt=5',
            function (data) {
                console.log(data);
                fill_form(data);
            }
    ...
    function fill_form(data) {
        ...
        $('#add_img').html('<img src="img/weather_ico/' + data.weather[0].icon + '.png" width = "20px" height = "20px" alt="weather_ico">');
        var i = 1;
